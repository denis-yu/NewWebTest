...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(self, port=0, executable_path="/usr/bin/safaridriver", reuse_service=False,
        ...
        Creates a new Safari driverLibs instance and launches or finds a running safaridriver service.
        ...
        :Args:
         ...
         - quiet - If True, the driverLibs's stdout and stderr is suppressed.
