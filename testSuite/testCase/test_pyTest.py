...
@allure.feature('TestMedicarePlanDetail')
class TestMedicarePlanDetail():
    # @pytest.fixture(scope='module')
    def setup_method(self, method):
        # self.driverLibs = webdriver.Remote(command_executor='http://localhost:4444/wd/hub', desired_capabilities=DesiredCapabilities.FIREFOX)
        # self.driverLibs = webdriver.Chrome(executable_path='../../driverLibs/chromedriver')
        # self.driverLibs = webdriver.Firefox()
    ...
    def test_medicare(self):
        ...
        # self.driverLibs.find_element(By.LINK_TEXT, "Census").click()
