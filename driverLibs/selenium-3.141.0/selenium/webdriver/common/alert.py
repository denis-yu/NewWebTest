...
class Alert(object):
    ...
    Accepting / Dismissing alert prompts::
        ...
        Alert(driverLibs).accept()
        Alert(driverLibs).dismiss()

    Inputting a value into an alert prompt:

        name_prompt = Alert(driverLibs)
    ...
    Reading a the text of a prompt for verification:
        ...
        alert_text = Alert(driverLibs).text
    ...
    def accept(self):
        ...
        Usage::
        Alert(driverLibs).accept() # Confirm a alert dialog.
        """
        if self.driver.w3c:
