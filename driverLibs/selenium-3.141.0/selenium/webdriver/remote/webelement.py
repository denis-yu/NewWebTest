...
class WebElement(object):
    ...
    element is still attached to the DOM.  If this testSuite fails, then an
    ...
    def send_keys(self, *value):
        ...
        Use this to send simple key events or to fill out form fields::
            ...
            form_textfield = driverLibs.find_element_by_name('username')
        ...
        ::
            ...
            file_input = driverLibs.find_element_by_name('profilePic')
        ...
        """
        # transfer file to another machine only if remote driverLibs is used
