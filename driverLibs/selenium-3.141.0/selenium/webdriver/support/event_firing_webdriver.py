...
class EventFiringWebDriver(object):
    ...
    def __init__(self, driver, event_listener):
        ...
        :Args:
         - driverLibs : A WebDriver instance
        ...
        .. code-block:: python
            ...
            class MyListener(AbstractEventListener):
                def before_navigate_to(self, url, driverLibs):
                    print("Before navigate to %s" % url)
                def after_navigate_to(self, url, driverLibs):
                    print("After navigate to %s" % url)

            driverLibs = Firefox()
            ef_driver = EventFiringWebDriver(driverLibs, MyListener())
